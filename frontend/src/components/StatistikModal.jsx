      ...
      {kampf.spieler1_id === spieler.user_id ? (
        <>
          ...
          <div className="flex flex-col justify-center text-sm flex-grow">
            <div>
              Ihr habt insgesamt <span className="font-bold">{kampf.gesamt_kaempfe}</span>x gekämpft<br></br>
              du hast {kampf.gegner_username}<span className="font-bold">{kampf.ich_hab_ihn_angegriffen}</span>x angegriffen<br></br>
        ...
        <>
          ...
          <div className="flex flex-col justify-center text-sm flex-grow">
            <div>
              Ihr habt insgesamt <span className="font-bold">{kampf.gesamt_kaempfe}</span>x gekämpft<br></br>
              {kampf.gegner_username} hat dich <span className="font-bold">{kampf.er_hat_mich_angegriffen}</span>x angegriffen<br></br>
